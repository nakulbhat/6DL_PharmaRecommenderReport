...
\begin{tabular}{lll}
\toprule
Author & Dataset / Task & Model \\
\midrule
Arnav Sahu & Disease--Drug & MLP \\
Pratyush Bhagat & Symptom--Disease & Self Attention \\
Nakul Bhat & Drug--Drug Interaction & BiLSTM \\
Hrithiq Gupta & Dataset Generation & FusionNet, CNN \\
\bottomrule
\end{tabular}
    \end{table}
