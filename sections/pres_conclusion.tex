...
\begin{frame}{Authors' Contributions}
    ...
    \begin{table}
        \caption{Dataset Generation Contribution}
        \begin{tabular}{ll}
            \toprule
            Task & Author \\
            \midrule
            Disease--Drug Mapping & Arnav Sahu \\
            Symptom--Disease Mapping & Pratyush Bhagat \\
            Drug--Drug Interaction Mapping & Nakul Bhat \\
            Dataset Combination \& Generation & Hrithiq Gupta \\
            \bottomrule
        \end{tabular}
    \end{table}
    ...
    \begin{table}
        ...
        \begin{tabular}{ll}
            ...
            MLP & Arnav Sahu \\
            BiLSTM & Nakul Bhat \\
            Self Attention & Pratyush Bhagat \\
            FusionNet, CNN & Hrithiq Gupta \\
            \bottomrule
        \end{tabular}
    \end{table}
